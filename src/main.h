...
public:
    ...
    {
        // EXEcoin: the coin stake transaction is marked with the first output empty
    ...
    */
    ...
    bool GetCoinAge(CTxDB& txdb, uint64_t& nCoinAge) const;  // EXEcoin: get transaction coin age
...
public:
    ...
    // EXEcoin: block signature - signed by one of the coin base txout[N]'s owner
    ...
    // EXEcoin: two types of block: proof-of-work or proof-of-stake
    ...
    // EXEcoin: get max transaction timestamp
    ...
    bool AcceptBlock();
    bool GetCoinAge(uint64_t& nCoinAge) const; // EXEcoin: calculate total coin age spent in block
...
public:
    ...
    unsigned int nFile;
    unsigned int nBlockPos;
    uint256 nChainTrust; // EXEcoin: trust score of block chain
    int nHeight;

    int64_t nMint;
    int64_t nMoneySupply;

    unsigned int nFlags;  // EXEcoin: block index flags
    enum  
    {
